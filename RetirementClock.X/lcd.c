/****************************************************************************
 ...
 Author:    Mohamed Lanjri El Halimi <mohamed.lanjri@gmail.com> https://github.com/Moji14/megaAVR-0-Series-LCD-library
...
#define lcd_e_high()    LCD_E_PORT.OUT  |=  _BV(LCD_E_PIN);
#define lcd_e_low()     LCD_E_PORT.OUT  &= ~_BV(LCD_E_PIN);
#define lcd_e_toggle()  toggle_e()
#define lcd_rw_high()   LCD_RW_PORT.OUT |=  _BV(LCD_RW_PIN)
#define lcd_rw_low()    LCD_RW_PORT.OUT &= ~_BV(LCD_RW_PIN)
#define lcd_rs_high()   LCD_RS_PORT.OUT |=  _BV(LCD_RS_PIN)
